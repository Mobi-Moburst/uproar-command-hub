...
import { clients, placements, awards } from "@/data/mockData";
    ...
    <DashboardLayout>
      <div className="stripe-gap">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground font-mono">{clients.length} clients total · {clients.filter(c => c.status === "Active").length} active</p>
        </div>
